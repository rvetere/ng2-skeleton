...
module.exports = {
   ...
   module: {
      ...
      loaders: [
         ...
         // Support for *.scss files, but extract them during build
         {test: /\.scss$/, loader: ExtractTextPlugin.extract('style-loader?sourceMap', ['css-loader?sourceMap', 'postcss-loader?sourceMap', 'sass-loader?sourceMap'])},
   ...
   plugins: [
      ...
      // copy all .html templates from src/app (all components mainly) -> so they can be loaded by xhr
